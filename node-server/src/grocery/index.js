...
const { register, login, addCategory, addItem, removeItem, updateItem, updateAccount, viewStock, viewItem, add, manageOrder, viewOrderElement } = require('./controller/grocery');
