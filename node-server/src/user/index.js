...
const { register, login, get, authUser, viewGroceries, viewCategories, viewItem, updateProfile, reviewGrocery, createOrder, addElement, viewCart, viewElement, findNearbyGroceries } = require('./controller/user');
