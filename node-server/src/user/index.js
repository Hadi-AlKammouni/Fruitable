...
const { register, login, get, authUser, viewGroceries, viewCategories, viewStock, updateProfile, reviewGrocery, createOrder, addElement, viewCart, viewElement } = require('./controller/user');
